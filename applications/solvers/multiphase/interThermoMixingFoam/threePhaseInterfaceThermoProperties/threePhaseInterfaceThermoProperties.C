...
#include "threePhaseInterfaceThermoProperties.H"
...
void Foam::threePhaseInterfaceThermoProperties::correctContactAngle
(
...
void Foam::threePhaseInterfaceThermoProperties::calculateK()
{
...
Foam::threePhaseInterfaceThermoProperties::threePhaseInterfaceThermoProperties
(
    const incompressibleThreePhaseThermoMixture& mixture
)
:
    mixture_(mixture),
    cAlpha_
